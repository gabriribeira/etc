...
const ExpenseDetail = () => {
  ...
  if (!expense || !authUser) return null;
    ...
    <div className="relative bg-white min-h-screen">
      ...
      <main className="mt-32">
        <div className="flex flex-col px-4 mt-6 fade-in">
          ...
          {!expense.is_paid && authUser && !userHasPaid && (
          ...
          {!expense.is_paid && authUser && authUser.id === expense.payer.id && (
            <>
              <div className="fixed bottom-[140px] left-0 w-full flex justify-center px-3 pb-3">
                <Button label="Mark Entire Expense as Paid" stroke={true} action={() => {
                  ...
                  if (unpaidMembers.length > 0) {
                    setShowMarkWholeExpenseConfirmation(true);
                  } else {
